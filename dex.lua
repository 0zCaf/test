...
Main = (function()
	...
	Main.CreateMainGui = function()
		...
		Main.CreateApp({Name = "Dex Honey", IconMap = Main.LargeIcons, Icon = "Output", Window = SecretServicePanel.Window})
...
--for i,v in pairs(Main.MissingEnv) do print(i,v) endv) end